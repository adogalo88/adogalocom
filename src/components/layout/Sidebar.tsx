...
const roleNavigation: Record<string, NavItem[]> = {
  CLIENT: [
    ...
    { title: 'Direktori', href: '/dashboard/directory', icon: <Search className="h-5 w-5" />, children: [
      { title: 'Cari Vendor', href: '/dashboard/directory/vendors', icon: <Building2 className="h-4 w-4" /> },
      { title: 'Cari Tukang', href: '/dashboard/directory/tukangs', icon: <Wrench className="h-4 w-4" /> },
      { title: 'Cari Supplier', href: '/dashboard/directory/suppliers', icon: <Truck className="h-4 w-4" /> },
    ]},
  ...
  VENDOR: [
    ...
    { title: 'Pembayaran', href: '/dashboard/payments', icon: <Wallet className="h-5 w-5" /> },
    { title: 'Direktori Tukang', href: '/dashboard/directory/tukangs', icon: <Wrench className="h-5 w-5" /> },
    { title: 'Ulasan', href: '/dashboard/reviews', icon: <Star className="h-5 w-5" /> },
    { title: 'Pesan', href: '/dashboard/messages', icon: <MessageSquare className="h-5 w-5" /> },
    { title: 'Pengaturan', href: '/dashboard/settings', icon: <Settings className="h-5 w-5" /> },
  ],
  TUKANG: [
    ...
    { title: 'Pembayaran', href: '/dashboard/payments', icon: <Wallet className="h-5 w-5" /> },
    { title: 'Direktori Vendor', href: '/dashboard/directory/vendors', icon: <Building2 className="h-5 w-5" /> },
    { title: 'Ulasan', href: '/dashboard/reviews', icon: <Star className="h-5 w-5" /> },
    { title: 'Pesan', href: '/dashboard/messages', icon: <MessageSquare className="h-5 w-5" /> },
    { title: 'Pengaturan', href: '/dashboard/settings', icon: <Settings className="h-5 w-5" /> },
  ],
